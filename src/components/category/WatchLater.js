...
import './categoryStyles/WatchVideos.scss';
...
function WatchLater() {
  ...
  useEffect(() => {
    ...
    db.collection('watchlater').onSnapshot(snapshot => (
  ...
  return (
    <div className="watch-videos__container">
      <div className="watch-videos__videos">
